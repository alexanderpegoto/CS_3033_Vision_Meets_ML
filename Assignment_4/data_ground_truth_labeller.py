...
if __name__ == "__main__":
    base_dir = "/Users/alex/Documents/NYU/Classes/CS_3033_Computer_Vision/CS_3033_Vision_Meets_ML/Assignment_3" # folder containing all the images and annotations, with an index.txt file listing pairs to process
    output_ann_dir = 'data/matched_annotations' # to store the generated matched annotation files (one per pair), with format: match_id x y w h type
    visual_dir = 'data/visual_matches' # to store visualizations of matched pairs
